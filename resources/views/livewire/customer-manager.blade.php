<div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $customerId ? 'Edit Customer' : 'New Customer' }}</h5>
    ...
    <script>
        window.addEventListener('show-customer-modal', () => new bootstrap.Modal(document.getElementById('customerModal')).show());
        window.addEventListener('hide-customer-modal', () => bootstrap.Modal.getInstance(document.getElementById('customerModal'))?.hide());
        window.addEventListener('show-delete-modal', () => new bootstrap.Modal(document.getElementById('customerDeleteModal')).show());
        window.addEventListener('hide-delete-modal', () => bootstrap.Modal.getInstance(document.getElementById('customerDeleteModal'))?.hide());
    </script>
</div>
