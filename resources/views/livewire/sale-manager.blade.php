                                ...
                                <div class="card-body p-2">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6 justify-content-right">
                                            <button type="button" class="btn btn-dark" wire:click="showPendingFn">Pending Sales</button>
                                            <button type="button" class="btn btn-dark" wire:click="showTodaysFn">Today's Sales</button>
                                        </div>
                                    </div>
    ...
    @if($showSalesTables)
        <div class="card shadow-sm">
            <div class="card-header justify-content-between">
                ...
                <div>
                    @if($showPending)
                        <button type="button" class="btn btn-primary" wire:click="$set('showTodays',true)">Today's Sales</button>
                    @endif
                    @if($showTodays)
                        <button type="button" class="btn btn-primary" wire:click="$set('showPending',true)">Pending Sales</button>
                    @endif
                    <button type="button" class="btn-close" wire:click="$set('showSalesTables',false)"></button>
                </div>
